...
describe('Subscription', () => {
    ...
    describe('subscribeToCollection()', () => {
        it('should add the user to the subscribers', async () => {
            ...
            const collectionTokenIdOwner =
                await dataProtectorSharingContract.ownerOf(collectionTokenId);
            const collectionOwnerBalanceBefore =
                await pocoContract.balanceOf(collectionTokenIdOwner);
            ...
            const collectionOwnerBalanceAfter =
                await pocoContract.balanceOf(collectionTokenIdOwner);
            ...
            expect(subscriberBalanceAfter).to.equal(
                subscriberBalanceBefore -
                    ethers.parseUnits(subscriptionParams.price.toString(), 'gwei'),
            );
        ...
        it('should not extend lastSubscriptionExpiration when a user take a subscription ending before the previous lastSubscriptionExpiration', async () => {
            ...
            const secondSubscriptionEnd =
                secondSubscriptionBlockTimestamp + newSubscriptionDuration;
        ...
        it('should make a subscription with an approveAndCall', async () => {
            ...
            const callData = DataProtectorSharingFactory.interface.encodeFunctionData(
    ...
    describe('setSubscriptionParams()', () => {
        it('should set subscription parameters', async () => {
            ...
            expect(subscriptionParamsToArray(subscriptionParams)).to.deep.equal(
                retrievedParamsArray,
            );
        });
