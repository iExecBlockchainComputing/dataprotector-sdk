export const ABI = [
  ...
  {
    inputs: [
      { internalType: 'address', name: '_datasetOwner', type: 'address' },
      { internalType: 'string', name: '_datasetName', type: 'string' },
      { internalType: 'string', name: '_datasetSchema', type: 'string' },
    ...
    outputs: [{ internalType: 'contract IDataset', name: '', type: 'address' }],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    ...
    name: 'registry',
    outputs: [
      { internalType: 'contract IDatasetRegistry', name: '', type: 'address' },
    ],
