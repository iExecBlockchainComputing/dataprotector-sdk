...
describe('dataProtector.addAppToAppWhitelist()', () => {
  ...
  describe('When the given input are not a valid', () => {
    it('should throw the corresponding error if appWhitelist is not a valid address', async () => {
      // --- GIVEN
    ...
    it('should throw the corresponding error if app is not a valid address', async () => {
      // --- GIVEN
  ...
  describe('When the given appWhitelist does not pass preflight check', () => {
    it('should fail if the appWhitelist is registered in the appWhitelist registry', async () => {
      // --- GIVEN
    ...
    it('should fail if the appWhitelist is not owned by the sender', async () => {
  ...
  describe('When the given app is not own by the sharing contract', () => {
    it('should throw corresponding error if the app does NOT exist in the Poco registry', async () => {
      // --- GIVEN
    ...
    it('should throw corresponding error if the app is not owned by the sharing contract', async () => {
      // --- GIVEN
